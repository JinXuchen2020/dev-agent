...
public sealed record AgentType
{
    ...
    /// </summary>
    /// <param name="roleCode">The unique code identifying the agent role (e.g., "developer"). Must not be null or whitespace.</param>
    ...
    /// <summary>
    /// Predefined Architect agent type with role code "architect".
    /// </summary>
    public static readonly AgentType Architect = new("architect", "Architect", "Designs system architecture");

    /// <summary>
    /// Predefined Developer agent type with role code "developer".
    /// </summary>
    public static readonly AgentType Developer = new("developer", "Developer", "Writes code");

    /// <summary>
    /// Predefined Tester agent type with role code "tester".
    /// </summary>
    public static readonly AgentType Tester = new("tester", "Tester", "Writes and executes tests");

    /// <summary>
    /// Predefined Product Manager agent type with role code "pm".
    /// </summary>
    public static readonly AgentType ProductManager = new("pm", "Product Manager", "Defines requirements");

    /// <summary>
    /// Predefined Tech Writer agent type with role code "tech-writer".
    /// </summary>
    public static readonly AgentType TechWriter = new("tech-writer", "Tech Writer", "Creates documentation");

    /// <summary>
    /// Predefined Reviewer agent type with role code "reviewer".
    /// </summary>
    public static readonly AgentType Reviewer = new("reviewer", "Reviewer", "Reviews code and designs");

    /// <summary>
    /// Gets the collection of all predefined agent types: Architect, Developer, Tester, Product Manager, Tech Writer, and Reviewer.
    /// </summary>
    public static IReadOnlyList<AgentType> Predefined => new[] { Architect, Developer, Tester, ProductManager, TechWriter, Reviewer };

    /// <summary>
    /// Attempts to find a predefined agent type by its role code.
    /// </summary>
    /// <param name="roleCode">The role code to search for (e.g., "developer").</param>
