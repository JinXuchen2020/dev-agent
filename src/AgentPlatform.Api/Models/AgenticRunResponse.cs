...
/// <param name="RunId">Identifier of this run; used to fetch its artifacts via the artifacts endpoint.</param>
/// <param name="Artifacts">Files generated by the run, available for preview/download.</param>
