...
namespace AgentPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260901015823_AddConversationAgentId")]
    partial class AddConversationAgentId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentPlatform.Domain.Aggregates.Conversations.Conversation", b =>
                {
                    ...
                    b.HasIndex("TenantId", "WorkflowId", "AgentId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AgentPlatform.Domain.Aggregates.PlatformModels.PlatformModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PlatformModels", (string)null);
                });
